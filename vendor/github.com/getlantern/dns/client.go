...
type Client struct {
	...
	CustomDial func(network, address string, timeout time.Duration) (net.Conn, error) // optional function for dialing
...
func (c *Client) Dial(address string) (conn *Conn, err error) {
	...
	if c.CustomDial != nil {
		conn.Conn, err = c.CustomDial(network, address, timeout)
	} else {
	...
	if useTLS {
		conn.Conn = tls.Client(conn.Conn, c.TLSConfig)
	}
