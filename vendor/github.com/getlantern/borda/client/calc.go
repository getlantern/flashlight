...
func init() {
	msgpack.RegisterExt(20, Sum(0))
	msgpack.RegisterExt(21, Float(0))
	msgpack.RegisterExt(22, Min(0))
	msgpack.RegisterExt(23, Max(0))
	msgpack.RegisterExt(24, Avg(0))
	msgpack.RegisterExt(25, Percentile(0))
}
