...
func collectDiagnostics(proxies []balancer.Dialer, trafficLog *trafficlog.TrafficLog) (
...
func saveAndZipProxyTraffic(addresses []string, trafficLog *trafficlog.TrafficLog) ([]byte, error) {
