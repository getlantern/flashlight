...
func TestInterstitialAdsEnabled(t *testing.T) {
	...
	assert.True(t, gl.FeatureEnabled(FeatureInterstitialAds, "android", common.DefaultAppName, "7.0.0", 1, false, "cn"), "Interstitial ads are enabled in China")
...
func TestCASInterstitialAdsEnabled(t *testing.T) {
	...
	assert.False(t, gl.FeatureEnabled(FeatureCASInterstitialAds, "android", common.DefaultAppName, "7.0.0", 1, false, "ru"), "CASInterstitial ads are disabled in Russia")
