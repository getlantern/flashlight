...
var cloudflareMasquerades = &client.MasqueradeSet{
    ...
    Masquerades: []*client.Masquerade{ 
    	...
    	&client.Masquerade{
    		Domain:    "agentlk.com",
    		IpAddress: "190.93.242.73",
    	}, 
    	&client.Masquerade{
    		Domain:    "aitnews.com",
    		IpAddress: "104.20.18.79",
    	}, 
    	&client.Masquerade{
    	...
    	&client.Masquerade{
    		...
    		IpAddress: "162.159.246.5",
    	}, 
    	&client.Masquerade{
    		Domain:    "libertyland.tv",
    		IpAddress: "162.159.254.102",
    	}, 
    	&client.Masquerade{
    		Domain:    "lifebuzz.com",
    	...
    	&client.Masquerade{
    		...
    		IpAddress: "190.93.255.31",
    	}, 
    	&client.Masquerade{
    		Domain:    "ocioso.com.br",
    		IpAddress: "108.162.203.94",
    	}, 
    	&client.Masquerade{
    		Domain:    "officegeteasy.com",
    		IpAddress: "108.162.205.208",
    	}, 
    	&client.Masquerade{
    		Domain:    "ojooo.com",
    	...
    	&client.Masquerade{
    		Domain:    "woorank.com",
    		IpAddress: "190.93.243.25",
    	}, 
    	&client.Masquerade{
    		Domain:    "www.4chan.org",
    		IpAddress: "190.93.255.123",
    	}, 
    	&client.Masquerade{
    		Domain:    "www.aciprensa.com",
    		IpAddress: "190.93.249.109",
    	}, 
    	&client.Masquerade{
