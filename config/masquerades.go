...
var cloudflareMasquerades = &client.MasqueradeSet{
    TrustedCAs: []*client.CA{ 
        &client.CA{
    ...
    Masquerades: []*client.Masquerade{ 
    	...
    	&client.Masquerade{
    		...
    		IpAddress: "198.41.188.77",
    	}, 
    	&client.Masquerade{
    		Domain:    "addmefast.com",
    		IpAddress: "190.93.249.30",
    	}, 
    	&client.Masquerade{
    		Domain:    "adf.ly",
    	...
    	&client.Masquerade{
    		...
    		IpAddress: "190.93.253.48",
    	}, 
    	&client.Masquerade{
    		Domain:    "bikroy.com",
    		IpAddress: "162.159.254.158",
    	}, 
    	&client.Masquerade{
    		Domain:    "bittrex.com",
    	...
    	&client.Masquerade{
    		...
    		IpAddress: "141.101.115.140",
    	}, 
    	&client.Masquerade{
    		Domain:    "dangerousminds.net",
    		IpAddress: "108.162.204.197",
    	}, 
    	&client.Masquerade{
    	...
    	&client.Masquerade{
    		...
    		IpAddress: "190.93.254.123",
    	}, 
    	&client.Masquerade{
    		Domain:    "www.aciprensa.com",
    		IpAddress: "190.93.248.109",
    	}, 
    	&client.Masquerade{
    	...
    	&client.Masquerade{
    		Domain:    "xendan.org",
    		IpAddress: "190.93.242.133",
    	}, 
    	&client.Masquerade{
    		Domain:    "yell.ru",
    		IpAddress: "198.41.186.83",
    	}, 
    	&client.Masquerade{
    		Domain:    "yeniakit.com.tr",
    		IpAddress: "162.159.255.25",
    	}, 
    	&client.Masquerade{
