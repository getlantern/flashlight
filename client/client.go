...
func NewClient(proxyAll func() bool, proTokenGetter func() string) *Client {
	...
	client.interceptCONNECT = proxy.CONNECT(443, keepAliveIdleTimeout, buffers, client.dialCONNECT)
	client.interceptHTTP = proxy.HTTP(false, keepAliveIdleTimeout, nil, nil, client.dialHTTP)
	return client
}
