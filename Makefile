...
binaries: docker-linux docker-windows darwin

packages: require-version require-secrets clean-desktop clean-mobile docker-package-windows docker-package-linux package-darwin package-android
...
pkg/gomobile: bin/gomobile vendor
	@gomobile init
