...
define build-tags
	...
	if [[ ! -z "$$REPLICA" && ! -z "$$YINBI" ]]; then \
		EXTRA_LDFLAGS="$$EXTRA_LDFLAGS -X github.com/getlantern/flashlight/common.EnableReplicaFeatures=true -X github.com/getlantern/flashlight/common.EnableYinbiFeatures=true"; \
