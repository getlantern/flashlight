...
require (
	...
	github.com/getlantern/auth-server v0.0.0-20210323190114-bf76c7337eb8 // indirect
	...
	github.com/getlantern/yinbi-server v0.0.0-20210323190417-61dc412d20fe // indirect
