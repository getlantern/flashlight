...
require (
	...
	github.com/getlantern/lantern-server v0.0.0-20200129201426-6177fb932037
	...
	github.com/getlantern/yinbi-server v0.0.0-20200203174156-f03047c10cdf
	...
	github.com/stellar/go v0.0.0-20200131213215-a135d590c455
