...
require (
	...
	github.com/getlantern/http-proxy-lantern/v2 v2.8.1-0.20230612184432-3874cd2c8884
...
require (
	...
	github.com/getlantern/http-proxy v0.0.3-0.20230405160101-eb4bf4e4a733 // indirect
