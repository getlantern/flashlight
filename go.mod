...
require (
	...
	github.com/getlantern/quicproxy v0.0.0-20220706115310-e874efcd6d64
...
require github.com/getlantern/libp2p v0.0.0-00010101000000-000000000000
...
// replace github.com/getlantern/geolookup => ../geolookup
