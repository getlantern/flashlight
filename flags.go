...
type Flags struct {
	...
	P2pBep46Targets      []string      `flag:"p2p-bep46-targets" help:"comma separated list of BEP-46 targets to use for P2P when p2p-censoredpeer feature is enabled. This overrides other sources"`
	P2pRegistrarEndpoint string        `flag:"p2pregistrar-endpoint" help:"Endpoint to use for P2P when p2p-freepeer feature is enabled. This overrides other sources"`
}
