...
func init() {
	...
	providers["akamai"] = newProvider(
		...
		map[string]string{
			...
			"config.ss7hc6jm.io":               "config.dsa.akamai.getiantem.org",
			"config-staging.getiantem.org":     "config-staging.dsa.akamai.getiantem.org",
			"config-staging.ss7hc6jm.io":       "config-staging.dsa.akamai.getiantem.org",
			...
			"update.ss7hc6jm.io":               "update.dsa.akamai.getiantem.org",
	...
	providers["edgecast"] = newProvider(
		...
		map[string]string{
			...
			"config.ss7hc6jm.io":               "config.edgecast.getiantem.org",
			"config-staging.getiantem.org":     "config-staging.edgecast.getiantem.org",
			"config-staging.ss7hc6jm.io":       "config-staging.edgecast.getiantem.org",
			...
			"update.ss7hc6jm.io":               "update.edgecast.getiantem.org",
