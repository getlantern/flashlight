flashlight ![Travis CI Status](https://travis-ci.org/getlantern/flashlight.svg?branch=master)&nbsp;[![Coverage Status](https://coveralls.io/repos/getlantern/flashlight/badge.png)](https://coveralls.io/r/getlantern/flashlight)
==========
