...
[Full Changelog](https://github.com/getlantern/flashlight/compare/6.0.10...HEAD)
...
- add hi definition beam .ico files [\#924](https://github.com/getlantern/flashlight/pull/924) ([joesis](https://github.com/joesis))
- generate high res icons file [\#923](https://github.com/getlantern/flashlight/pull/923) ([myleshorton](https://github.com/myleshorton))
- Lots of beam fixes [\#922](https://github.com/getlantern/flashlight/pull/922) ([myleshorton](https://github.com/myleshorton))
- Updated to latest ipproxy [\#921](https://github.com/getlantern/flashlight/pull/921) ([oxtoacart](https://github.com/oxtoacart))
- updated beam UI [\#920](https://github.com/getlantern/flashlight/pull/920) ([myleshorton](https://github.com/myleshorton))
- always use 32x32 icons for systray [\#919](https://github.com/getlantern/flashlight/pull/919) ([joesis](https://github.com/joesis))
- latest beam UI [\#918](https://github.com/getlantern/flashlight/pull/918) ([myleshorton](https://github.com/myleshorton))
- Add MustProxy to domainrouting rules [\#917](https://github.com/getlantern/flashlight/pull/917) ([max-b](https://github.com/max-b))
- Config fixes for ui [\#916](https://github.com/getlantern/flashlight/pull/916) ([myleshorton](https://github.com/myleshorton))
- latest beam [\#915](https://github.com/getlantern/flashlight/pull/915) ([myleshorton](https://github.com/myleshorton))
- update server path now differs only by app name [\#914](https://github.com/getlantern/flashlight/pull/914) ([joesis](https://github.com/joesis))
- Dial domainsRequiringProxy via proxy even if lantern client is 'disconnected' [\#913](https://github.com/getlantern/flashlight/pull/913) ([max-b](https://github.com/max-b))
- Various beam UI fixes [\#912](https://github.com/getlantern/flashlight/pull/912) ([myleshorton](https://github.com/myleshorton))
- use our own fork of crawshaw.io/sqlite [\#911](https://github.com/getlantern/flashlight/pull/911) ([joesis](https://github.com/joesis))
- Simplify helloCacheFile [\#910](https://github.com/getlantern/flashlight/pull/910) ([hwh33](https://github.com/hwh33))
- Fix UI bugs with submitting issues [\#909](https://github.com/getlantern/flashlight/pull/909) ([myleshorton](https://github.com/myleshorton))
- Fix config dir creation on startup [\#908](https://github.com/getlantern/flashlight/pull/908) ([myleshorton](https://github.com/myleshorton))
...
- Fix REPLICA and other Makefile flag handling [\#900](https://github.com/getlantern/flashlight/pull/900) ([max-b](https://github.com/max-b))
- latest beam ui [\#899](https://github.com/getlantern/flashlight/pull/899) ([myleshorton](https://github.com/myleshorton))
- Reuse domains across apps for simplicity [\#898](https://github.com/getlantern/flashlight/pull/898) ([myleshorton](https://github.com/myleshorton))
- changes to support dark mode on Mac [\#897](https://github.com/getlantern/flashlight/pull/897) ([joesis](https://github.com/joesis))
- Use app-specific icons for the system tray [\#896](https://github.com/getlantern/flashlight/pull/896) ([myleshorton](https://github.com/myleshorton))
- try make ios test more reliable [\#895](https://github.com/getlantern/flashlight/pull/895) ([joesis](https://github.com/joesis))
- Update TRAY\_QUIT translation template string [\#893](https://github.com/getlantern/flashlight/pull/893) ([max-b](https://github.com/max-b))
- force proxying beam related domains [\#892](https://github.com/getlantern/flashlight/pull/892) ([joesis](https://github.com/joesis))
- Fix missing template string translation [\#891](https://github.com/getlantern/flashlight/pull/891) ([max-b](https://github.com/max-b))
- Add pro available per app flag [\#890](https://github.com/getlantern/flashlight/pull/890) ([myleshorton](https://github.com/myleshorton))
- Add Beam backend services [\#889](https://github.com/getlantern/flashlight/pull/889) ([myleshorton](https://github.com/myleshorton))
- Fixing errors while running logging\_test [\#888](https://github.com/getlantern/flashlight/pull/888) ([oxtoacart](https://github.com/oxtoacart))
- Update translation handling to allow for white label application names; Update systray to be configurable re: displaying pro upgrade [\#887](https://github.com/getlantern/flashlight/pull/887) ([max-b](https://github.com/max-b))
...
- Specify beam or lantern UI with build tags [\#885](https://github.com/getlantern/flashlight/pull/885) ([myleshorton](https://github.com/myleshorton))
