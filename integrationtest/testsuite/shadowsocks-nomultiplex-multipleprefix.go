...
func (t *Test_Shadowsocks_NoMultiplex_MultiplePrefix) GetName() string {
...
func (t *Test_Shadowsocks_NoMultiplex_MultiplePrefix) Init(
	...
	p := &httpProxyLantern.Proxy{
		ProxyName:         "localtest-shadowsocks-no-multiplex-multiple-prefix",
...
func (t *Test_Shadowsocks_NoMultiplex_MultiplePrefix) Run(
