...
func (uc *UserConfigData) GetUserID() string   { return uc.UserID }
...
func NewUserConfigData(deviceID, userID, token string, headers map[string]string, lang string) *UserConfigData {
	uc := &UserConfigData{
		DeviceID: deviceID,
		UserID:   userID,
		Token:    token,
